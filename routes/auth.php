...
Route::middleware([CheckAdmin::class])->group(function () {
    ...
    Route::get('user', [App\Http\Controllers\DASHBOARD_ADMIN\ProductFilesController::class, 'user'])->name('admin.user.index');
    Route::get('cashier', [App\Http\Controllers\DASHBOARD_ADMIN\ProductFilesController::class, 'cashier'])->name('admin.cashier.index');
