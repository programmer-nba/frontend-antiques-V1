<template>
        <div class="card-header" style="">
          ...
          <div class="col-sm-3 col-md-1">
            <input type="email" class="form-control" id="email" value="66REC1103" name="email">
          </div>
    ...
    <tr>
       <td @click="showModal" >
        <img  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnqaInVc1iASODNTtkxaSp7Z_zoIDUDMNArKQwxCHUHw&s" alt="" style="height:80px;width:80px;margin-right:20px;">
       </td>
       <td>
        <img @click="getOrderDataByDateAndQueue()" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRLQDlDeKd8O4BrfOk6iuyzaaqXITgUJ69Zzw&usqp=CAU" alt="" style="height:80px;width:80px;margin-right:20px;">
       </td>
       <td>
        <img  src="https://cdn-icons-png.flaticon.com/512/4856/4856668.png" alt="" style="height:80px;width:80px;margin-right:20px;">
       </td>
       <td>
        <img  src="https://icons-for-free.com/iconfiles/png/512/print-131964753156480777.png" alt="" style="height:80px;width:80px;margin-right:20px;">
       </td>
    </tr>
 </table>
