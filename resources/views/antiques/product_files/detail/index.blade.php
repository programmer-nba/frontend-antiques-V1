            ...
            <div class="card-body">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item "><a  href="{{route('product_files.type.index', 1)}}">เพิ่มประเภทสินค้า</a></li>
                      <li class="breadcrumb-item active" aria-current="page">เพิ่มรายละเอียดสินค้า</li>
                    </ol>
                  </nav>
                  <h3>หน้าเพิ่มรายละเอียดสินค้าสำหรับหมวดหมู่ 001 - กระดาษ ประเภท 101 - กระดาษแข็ง</h3>
                <div style="float:right;">
                    <modal modal-id="add" title="เพิ่มรายละเอียดสินค้า" button-text="เพิ่มรายละเอียดสินค้า" class-name="btn btn-primary" icon-name="fa fa-plus">
                        <form role="form" method="POST" action="{{route('product_files.store')}}">
                            @csrf
                            <div class="form-group">
                                <label class="control-label">ชื่อสินค้า (ไทย)	</label>
                                <div>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="number" class="form-control input-lg" name="cost">
                                </div>
                            </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{route('product_files.detail.edit', ['id' => 1, 'type_id' => 1])}}" class="btn btn-warning mr-2"><i class="fa fa-edit "></i></a>
